...
<body style="background-image: url('/webapp_res/background2.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-attachment: fixed;">
	<div class="page-header text-center bg-primary pt-4 pl-4 pr-4 pb-2 text-white" style="margin: 0; padding-right: 20px; padding-bottom: 0.005mm; height: fit-content;">
		<h3 >Creator <u>SIGNUP</u> - Fly High Airlines</h3>
            ...
            <div class="col-md-12" style="padding-right: 40px;">
                <div class="panel panel-default small-border">
                    <div class="panel-heading" style="margin-bottom: 50px;">
                        <h3 class="panel-title" style="color: blue; text-align: center;">Enter credentials to sign up</h3>
                    </div>
                        ...
                        <form action="/creator/signup" method="post">
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-12 text-center font-weight-bold">
                                    <button class="login btn btn-primary" style="transition: 200ms;">Sign Up</button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        ...
        if(${result} == 1) showMessage('Customer Successfully Signed Up ...')
        else if(${result} == 2) showMessage('Customer / Admin with same name already exists, not signed up ...')
    </script>
