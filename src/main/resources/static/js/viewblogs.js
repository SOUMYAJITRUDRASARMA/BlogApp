...
addBlogToList = (blog) => {
    ...
    elemDiv.innerHTML = '<div class="small-border flight-item">' + getBlogStr(blog) + '<div class="text-right"> <a href="/viewblogs?id=' + blog.id + '" target="_blank"><button class="login btn btn-primary" style="transition: 200ms;">View</button></a></div></div>'
